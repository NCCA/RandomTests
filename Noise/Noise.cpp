...
float Noise::noise(float _scale, const Point &_p)
{
...
//----------------------------------------------------------------------------------------------------------------------
float Noise :: turbulance(float _scale, const Point &_p  )
{
...
float Noise::complex( int _steps,float _persistence,float _scale, const Point &_p )
{
  float val=0.0;
